...
interface_icon     = config_loc + "shapingpattern_icon.png"
interface_title    = config_loc + "title.png"
interface_robot_title   = config_loc + "points_and_robots.png"
interface_info     = config_loc + "info.png"
interface_axes     = config_loc + "coordinate_system.png"
...
# Information text
info_text       = ["Usage Information:", 
                    "Left-click to draw",  
                    "Right-click to erase", 
                    "Press 'Draw' to generate turtle points", 
                    "Press 'Send' to start turtle movement"]
